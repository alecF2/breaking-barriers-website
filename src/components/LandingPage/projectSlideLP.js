  ...
  autoplaySpeed="5000">
    <div className="barriers-who-we-are">
				...
				<div className="first-frame">
					<img src="images/students.jpeg" class="dog"></img><br></br>
				...
				<button class="learn-more"><a href="/currentProjects">learn more</a></button>
    </div>
    <div className="mission-main">			
				<h1>Our Mission Statement</h1>
				<div className="first-frame">
					<img src="images/circles/LPRectangle500.svg" class="w2frame"></img>
					<img src="images/home_mission.jpg" class="dog2"></img><br></br>
				</div>
				...
				<button class="volunteer"><a href="/contactUs">volunteer with us!</a></button>
			</div>
    ...
    <h1>Tidbits About Us</h1>
				...
				<div className="first-frame">
					...
					<img src="images/uc davis.jpeg" class="firstTid"></img><br></br>
				</div>
    ...
    <h1>Tidbits About Us</h1>
				...
				<div className="first-frame">
					...
					<img src="images/inspiration.jpg" class="secondTid"></img><br></br>
					</div>
    ...
    <h1>Tidbits About Us</h1>
				...
				<div className="first-frame">
					...
					<img src="images/when.jpg" class="thirdTid"></img><br></br>
				</div>
