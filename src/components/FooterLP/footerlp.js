...
const FooterLP = () =>{
	return(
		<React.Fragment>
			<div className="barriers-footer-additions">
				<img id="addFooterTree" src="images/add-footer-single-tree.svg"/>
				<img id="addFooterTrees" src="images/add-footer-trees.svg"/>
				<img id="addFooter" src="images/add-to-footer.svg"/>
			</div>
